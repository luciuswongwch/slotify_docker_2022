			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="loginPassword" name="loginPassword" type="password" value="<?php getInputValue("loginPassword"); ?>" required>
					</p>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="password2" name="password2" type="password" value="<?php getInputValue("password2"); ?>" required>
					</p>
